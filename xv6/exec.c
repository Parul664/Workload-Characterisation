...
exec(char *path, char **argv)
{
  ...
  for(loopVar = 0; argv[loopVar]; loopVar++) {
    ...
    cprintf("Value of strlen: %d\n", tempA);
    cprintf("Value of strcmp: %d\n", tempB);
    if((tempA==5) && (tempB== 0)){ // strlen(argv[loopVar])==5 && argv[loopVar][0]=='-' && argv[loopVar][1] == 'X' && argv[loopVar][2] == 'O' && argv[loopVar][3] == 'X' && argv[loopVar][4] == 'O'){
      startTracing = 1;
